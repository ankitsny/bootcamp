...
import static input.PersonExercise.ShanFamilyTreeBuilder.KING_SHAN;
import static input.PersonExercise.ShanFamilyTreeBuilder.QUEEN_ANGA;
...
public class PersonTest extends BaseTest {
    ...
    public void findSistersGivenAPerson() {
        ...
        assertEquals(0, JNKI.getSisters().size());
    }
